...
The canonical substantive review was due 2026-08-09. The tool refuses generation, download, and printing until the canonical source records are reviewed and rebuilt.

# AI Disclosure Starter File v1.0.0
...
- Build-time review state: `SOURCE REVIEW OVERDUE`
...
The merchant-upload archive is `ai-disclosure-starter-file-v1.0.0.zip`; it contains this versioned directory and exactly the entries declared by `manifest.json`.
